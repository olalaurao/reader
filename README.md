...
**Phase A / Gate 0 and Phase B / Gate 1 are complete; Phase C storage is integrated; Phase D Reader metadata is implemented and CI-validated.** The current experimental build is `0.0.3` and is waiting on **Gate 2** on the target Kindle Paperwhite 3 / KOReader 2025.04.
...
After installing the `0.0.3` Gate 2 build, enable Wi-Fi outside the plugin and use:
