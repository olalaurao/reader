...
## Gate 3 first article — 0.1.1 physical retest

Gate 3 attempt 1 on `0.1.0` reached **Loading Reader articles…** but returned to the menu without showing the candidate selector. `0.1.1` fixes that UI transition by closing the source TouchMenu and showing the selector on the next KOReader UI tick.

After installing the experimental `0.1.1` retest build, enable Wi-Fi outside the plugin and use:
