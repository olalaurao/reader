...
return function()
    ...
    do
        ...
        assert(states["article-1"].materialized_remote_updated_at
            == "2026-09-22T20:00:00Z")
        assert(states["article-1"].content_refresh_pending == false)
    ...
    do
        ...
        assert(states["pdf-1"].materialized_remote_updated_at == "u2")
        assert(states["pdf-1"].content_refresh_pending == false)
