...
local function summaryText(report)
    ...
    local lines = {
        ...
        string.format(_("Refresh pending examined: %d"), report.content_refresh_pending_seen or 0),
        string.format(_("Refresh articles compared: %d"), report.content_refresh_article_checked or 0),
        string.format(_("Metadata-only revisions acknowledged: %d"), report.content_refresh_metadata_only_acknowledged or 0),
        string.format(_("Changed-content revisions retained: %d"), report.content_refresh_changed_retained or 0),
        string.format(_("Raw PDF/EPUB revisions retained: %d"), report.content_refresh_raw_retained or 0),
        string.format(_("Unverified refresh revisions retained: %d"), report.content_refresh_unverified_retained or 0),
        string.format(_("Refresh local files missing: %d"), report.content_refresh_local_missing or 0),
        string.format(_("Refresh revision races retained: %d"), report.content_refresh_revision_races or 0),
        string.format(_("Refresh remote read errors: %d"), report.content_refresh_remote_errors or 0),
        ...
        string.format(_("Persisted unresolved guards matched locally: %d"), report.remote_highlight_import_persisted_guard_matches or 0),
...
Tap to cancel. Reader highlights for the open EPUB are reconciled before outbound annotation creates. Local annotations are then queued and Readwise reachability is verified before any remote write; the incremental watermark is committed only after a successful remote sync.]]))
        ...
        report.remote_highlight_import_persisted_guard_matches =
            import_report.persisted_guard_matches or 0
