...
return {
    ...
    REMOTE_HIGHLIGHT_IMPORT_MAX_PER_SYNC = 50,
    REMOTE_HIGHLIGHT_IMPORT_MAX_LOCATOR_ATTEMPTS = 75,
    PDF_REMOTE_HIGHLIGHT_IMPORT_MAX_PER_SYNC = 5,
    PDF_REMOTE_HIGHLIGHT_IMPORT_MAX_LOCATOR_ATTEMPTS = 30,
